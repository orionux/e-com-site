    ...
    <Layout>
      <>
        <div
          ...
          style={{
            backgroundImage: "url(assets/img/privacy-policy.png)",
                ...
                <div className="story-details pl-50">
                  <div className="story-details-top">
                    ...
                    <p>
                      ...
                      e-commerce platform, you consent to the practices
                  ...
                  <div className="story-details-bottom">
                    ...
                    <p>
                      ...
                      shopping experience. Usage Data: We may automatically
                      collect certain information when you visit our website,
                      such as your IP address, device information, browser type,
                      ...
                      but this may limit certain features of our platform.
                    </p>
                  </div>
                  <div className="story-details-bottom">
                    <h4>Information Use:</h4>
                    <p>
                      Order Processing: We use the personal information you
                      provide to process and fulfill your orders, communicate
                      order updates, and arrange for delivery. Personalization:
                      We may use your information to personalize your shopping
                      experience, recommend products, and provide targeted
                      advertisements based on your preferences and browsing
                      history. Customer Support: Your information helps us
                      respond to your inquiries, provide technical support, and
                      address any issues or concerns you may have. Marketing
                      Communications: With your consent, we may send you
                      promotional emails or newsletters about new products,
                      special offers, or upcoming events. You can opt out of
                  ...
                  <div className="story-details-bottom">
                    ...
                    <p>
                      ...
                      delivering orders, and analyzing data. These providers are
                      bound by confidentiality agreements and are only
                      authorized to use your information for specified purposes.
                      Legal Compliance: We may disclose your information to
                      comply with applicable laws, regulations, or legal
                      processes, or to respond to valid government requests or
                      inquiries.
                    </p>
                  </div>
                  <div className="story-details-bottom">
                  ...
                  <div className="story-details-bottom">
                    <h4>Your Rights:</h4>
                    <p>
                      You have the right to access, correct, or delete the
                      personal information we hold about you. You may also have
                      the right to restrict or object to certain data processing
                      activities. To exercise these rights, please contact us
                  ...
                  <div className="story-details-bottom">
                    ...
                    <p>
                      ...
                      this Privacy Policy or the way we handle your personal
