...
const Register = () => {
    ...
    const handleSubmit = async (e: { preventDefault: () => void; }) => {
        ...
        Object.keys(formData).forEach((key) => {
            formDataToSend.append(key as keyof typeof formData, formData[key as keyof typeof formData]);
        });
                                ...
                                <div className="login-form-container">
                                    <div className="login-form">
                                        <form onSubmit={handleSubmit}>
                                            ...
                                            <input type="text" name="vat_no" value={formData.vat_no} onChange={handleChange} placeholder="VAT No" required
                                                style={{ border: "solid 2px", borderColor: '#D3D3D3', borderRadius: '10px', height: '50px' }}></input>
                                            {/* KVK number */}
                                            <label htmlFor="Name" style={{ color: "black" }}>KVK Number<span style={{ color: "red" }}>*</span></label>
                                            <input type="text" name="kvk_no" value={formData.kvk_no} onChange={handleChange} placeholder="KVK No" required
                                                style={{ border: "solid 2px", borderColor: '#D3D3D3', borderRadius: '10px', height: '50px' }}></input>
                                            {/* country */}
