          ...
          <div className="slider-area">
            ...
            <div className="brand-logo-area-2 wrapper-padding ptb-80">
              <div className="container-fluid position-relative">
                <div className="d-flex w-100 d-flex justify-content-center" style={{position: 'absolute', top: 0, zIndex: 999, marginTop: '-30px',  overflow: 'hidden'}}>
                <img src="assets/img/Slider-images/curve-top.webp" alt="" className="img-fluid" style={{height: "100px", width: '100vw'}}></img>
                </div>
                <div className="brand-logo-active2 owl-carousel curved-slider">
                  <div className="single-brand">
                    <img src="assets/img/Slider-images/01.jpg" alt="" className="img-fluid"></img>
                  </div>
                  <div className="single-brand">
                    <img src="assets/img/Slider-images/02.jpg" alt=""  className="img-fluid"></img>
                  </div>
                  <div className="single-brand">
                    <img src="assets/img/Slider-images/03.jpg" alt=""  className="img-fluid"></img>
                  </div>
                  <div className="single-brand">
                    <img src="assets/img/Slider-images/04.jpg" alt=""  className="img-fluid"></img>
                  </div>
                  <div className="single-brand">
                    <img src="assets/img/Slider-images/05.jpg" alt=""  className="img-fluid"></img>
                  </div>
                </div>
                <div className="d-flex w-100 d-flex justify-content-center" style={{position: 'absolute', bottom: 0, zIndex: 999,marginBottom: "-50px", overflow: 'hidden'}}>
                <img src="assets/img/Slider-images/curve-bottom.webp" alt="" className="img-fluid" style={{height: "100px", width: '100vw'}}></img>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="popular-product-active owl-carousel">
                  <div className="product-wrapper">
                    <div className="product-img">
                      <a href="#">
                        <img src="assets/img/productimg/mm.png" alt="" />
                      </a>
                    ...
                    <div className="funiture-product-content text-center">
                      <h4>
                        <a href="product-details.html">Sofa Chaise Sleeper</a>
                      </h4>
                      <span>$90.00</span>
                    </div>
                  </div>
                  <div className="product-wrapper">
                    <div className="product-img">
                      <a href="#">
                        <img src="assets/img/productimg/hh.png" alt="" />
                      </a>
                      <div className="product-action">
                        <a className="animate-left" title="Wishlist" href="#">
                          <i className="pe-7s-like"></i>
                    ...
                    <div className="funiture-product-content text-center">
                      <h4>
                        <a href="product-details.html">Darcy Sofa</a>
                      </h4>
                      <span>$90.00</span>
                    </div>
                  </div>
                  <div className="product-wrapper">
                    <div className="product-img">
                      <a href="#">
                        <img src="assets/img/productimg/kk.png" alt="" />
                      </a>
                      <div className="product-action">
                        <a className="animate-left" title="Wishlist" href="#">
                          <i className="pe-7s-like"></i>
                    ...
                    <div className="funiture-product-content text-center">
                      <h4>
                        <a href="product-details.html">Bladen Sofa</a>
                      </h4>
                      <span>$90.00</span>
                    </div>
                  </div>
                  <div className="product-wrapper">
                    <div className="product-img">
                      <a href="#">
                        <img src="assets/img/productimg/oo.png" alt="" />
                      </a>
                      <div className="product-action">
                        <a className="animate-left" title="Wishlist" href="#">
                          <i className="pe-7s-like"></i>
                    ...
                    <div className="funiture-product-content text-center">
                      <h4>
                        <a href="product-details.html">Ardenboro Sofa</a>
                      </h4>
                      <span>$90.00</span>
                    </div>
                  </div>
                  <div className="product-wrapper">
                    <div className="product-img">
                      <a href="#">
                        <img src="assets/img/productimg/bb.png" alt="" />
                      </a>
                      <div className="product-action">
                        <a className="animate-left" title="Wishlist" href="#">
                          <i className="pe-7s-like"></i>
                    ...
                    <div className="funiture-product-content text-center">
                      <h4>
                        <a href="product-details.html">Daystar Sofa</a>
                      </h4>
                      <span>$90.00</span>
                    </div>
                  </div>
                  <div className="product-wrapper">
                    <div className="product-img">
                      <a href="#">
                        <img src="assets/img/productimg/dd.png" alt="" />
                      </a>
                      <div className="product-action">
                        <a className="animate-left" title="Wishlist" href="#">
                          <i className="pe-7s-like"></i>
                    ...
                    <div className="funiture-product-content text-center">
                      <h4>
                        <a href="product-details.html">Trivia Accent Chair</a>
                      </h4>
                      <span>$90.00</span>
                    </div>
                  </div>
                  ...
                  <div className="coustom-row-5">
                    <div className="custom-col-three-5 custom-col-style-5 mb-65">
                      <div className="product-wrapper">
                        <div className="product-img">
                          <a href="#">
                            <img src="assets/img/productimg/ee.png" alt="" />
                          </a>
                          <div className="product-action">
                            <a
                    ...
                    <div className="custom-col-three-5 custom-col-style-5 mb-65">
                      <div className="product-wrapper">
                        <div className="product-img">
                          <a href="#">
                            <img src="assets/img/productimg/fff.png" alt="" />
                          </a>
                          <div className="product-action">
                            <a
                              className="animate-left"
                    ...
                    <div className="custom-col-three-5 custom-col-style-5 mb-65">
                      <div className="product-wrapper">
                        <div className="product-img">
                          <a href="#">
                            <img src="assets/img/productimg/gg.png" alt="" />
                          </a>
                          <div className="product-action">
                            <a
                              className="animate-left"
                    ...
                    <div className="custom-col-three-5 custom-col-style-5 mb-65">
                      <div className="product-wrapper">
                        <div className="product-img">
                          <a href="#">
                            <img src="assets/img/productimg/ii.png" alt="" />
                          </a>
                          <div className="product-action">
                            <a
                              className="animate-left"
                    ...
                    <div className="custom-col-three-5 custom-col-style-5 mb-65">
                      <div className="product-wrapper">
                        <div className="product-img">
                          <a href="#">
                            <img src="assets/img/productimg/jj.png" alt="" />
                          </a>
                          <div className="product-action">
                            <a
                              className="animate-left"
                    ...
                    <div className="custom-col-three-5 custom-col-style-5 mb-65">
                      <div className="product-wrapper">
                        <div className="product-img">
                          <a href="#">
                            <img src="assets/img/productimg/ll.png" alt="" />
                          </a>
                          <div className="product-action">
                            <a
                              className="animate-left"
                    ...
                    <div className="custom-col-three-5 custom-col-style-5 mb-65">
                      <div className="product-wrapper">
                        <div className="product-img">
                          <a href="#">
                            <img src="assets/img/productimg/pp.png" alt="" />
                          </a>
                          <div className="product-action">
                            <a
                              className="animate-left"
