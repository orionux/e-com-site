                            ...
                            <form action="#">
                                ...
                                <div className="row">
                                    <div className="col-md-5 ms-auto d-flex justify-content-center">
                                        <div className="cart-page-total" style={{ width: '100%', maxWidth: '400px' }}>
                                            <h2>Cart totals</h2>
                                            <ul>
                                                <li>Subtotal<span>${getTotal().toFixed(2)}</span></li>
                                                <li>Total<span>${getTotal().toFixed(2)}</span></li>
                                            </ul>
                                            <button className='mt-4' type="button" onClick={handleCheckout} style={{ backgroundColor: "#333", color: "#fff", padding: "11px 20px", border: "none", outline: 'none' }}>
                                                Proceed to checkout
                                            </button>
                                        </div>
                                    </div>
