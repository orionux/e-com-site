          ...
          <div className="widget-wrapper">
            <div className="footer-widget mb-30 col-12 col-lg-6">
              ...
              <div className="footer-about-2">
                <p style={{ maxWidth: "70%" }}>
                  Ferolis is a Netherlands-based company specializing in smoking
            ...
            <div className="footer-widget mb-30 col-12 col-lg-6">
              ...
              <div className="footer-info-wrapper-3">
                ...
                <div className="footer-address-furniture">
                  ...
                  <div className="footer-info-content3">
                    <p>
                      <a href="mailto:  info@ferolis.com"> info@ferolis.com</a>{" "}
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="row">
            <div className="col-12 text-center">
              <div className="copyright-furniture">
                <p>
                  Copyright © 2024 <a href="/">Ferolis</a>. All Right Reserved -
                  Developed By ORION UX
                </p>
              </div>
            </div>
          </div>
